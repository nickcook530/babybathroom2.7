...
class CustomMapMarker(MapMarker):
    def __init__(self, name, description, *args, **kwargs):
        ...
        super(CustomMapMarker, self).__init__(*args, **kwargs)
...
class CustomMapView(MapView):
    ...
    def mark_me(self):
        ...
        m1 = CustomMapMarker(lon=my_lon, lat=my_lat, name=my_name, description=my_description, source=r'start_flag.png')
